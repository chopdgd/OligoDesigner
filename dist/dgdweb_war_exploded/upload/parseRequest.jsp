		...
		while (iter.hasNext()) {
		    ...
		    if (fileItem.isFormField()) {
                ...
                if(fileItem.getFieldName().equals("projectName")){
                    ...
                    proj_name = fileItem.getString();
                }
                if(fileItem.getFieldName().equals("uploadedFileLoc")){
                    System.out.println("upload folder here:");
                ...
                File f = new File(ourTempDirectory+"/"+proj_name);
