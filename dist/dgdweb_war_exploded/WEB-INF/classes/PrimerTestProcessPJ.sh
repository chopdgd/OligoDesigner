...
PRIMER_CMD="primer3_core -format_output -strict_tags -default_version=2 -io_version=4 -p3_settings_file=$PRIMER3_HOME/primer3_newsettings.txt -echo_settings_file -output=$PRIMERS_OUTPUT_FILE $PRIMER3_HOME/primer3Inp/$PRIMER_FILE"
