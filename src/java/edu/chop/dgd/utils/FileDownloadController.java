...
public class FileDownloadController {
    ...
    public static String getPrimer3InputDir() {
    ...
    public static String getPrimer3OpDir() {
        return primer3OpDir;
    }
    ...
    public static String getBlatInpDir() {
        return blatInpDir;
    }
    ...
    public static String getBlatOpDir() {
        return blatOpDir;
    }
    ...
    public static String getInsilicoPcrInputDir() {
    ...
    public static String getInsilicoPcrOpDir() {
    ...
    public static String getPrimerProcessScriptDir() {
